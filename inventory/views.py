...
from inventory.models import ProductInventories,MaterialDispatch
from inventory.serializers import MaterialDispatchSerializer,ProductInventoriesSerializer
...
class ProductInventoriesViews(BaseViews):
    authentication_classes = [JWTAuthentication]
    permission_classes = [permissions.IsAuthenticated,IsStaff]
    serializer_class = ProductInventoriesSerializer
