...
class propertyPurchase(CommonModel):
    ...
    final_return= models.DateField(default=datetime.date.today,blank=True)
...
class propertyInstallment(CommonModel):
    purchase_id = models.ForeignKey(propertyPurchase,on_delete=models.CASCADE,default=None)
    amount = models.FloatField()
