...
router.register(r'property-purchase',views.PropertyPurchaseViews,basename="property-purchase")
#router.register(r'property-purchase-filter',PropertyPurchaseFilterViews,basename="property-purchase-filter")
